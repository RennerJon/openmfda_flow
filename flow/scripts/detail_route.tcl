...
if { [info exists ::env(MIN_ROUTING_LAYER)] && [info exists ::env(MAX_ROUTING_LAYER)] } {
  ...
  set_routing_layers -signal "$::env(MIN_ROUTING_LAYER)-met10"
} elseif { [info exists ::env(MAX_ROUTING_LAYER)] } {
  set_routing_layers -signal "met1-$::env(MAX_ROUTING_LAYER)"
}
...
write_def $::env(RESULTS_DIR)/3_route.def
