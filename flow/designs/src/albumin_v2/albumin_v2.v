...
p_serpentine_0_360_30_48	serp0	(.in_fluid(soln1), .out_fluid(connect0));

p_serpentine_0_360_30_32	serp1	(.in_fluid(soln2), .out_fluid(connect1));

p_serpentine_0_360_30_8	serp2	(.in_fluid(soln3), .out_fluid(connect2));
