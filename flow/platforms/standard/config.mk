...
export GDS_FILES = $(sort $(wildcard $(PLATFORM_DIR)/pdk/distrib/0.0.1/*.gds)) \
                      $(ADDITIONAL_GDS)
export TECH_LEF ?= $(PLATFORM_DIR)/pdk/distrib/0.0.1/h.r.3.3.tlef
export SC_LEF ?= $(PLATFORM_DIR)/pdk/distrib/0.0.1/h.r.3.3_merged.lef

export LIB_FILES = $(PLATFORM_DIR)/pdk/distrib/0.0.1/h.r.3.3.lib \
                     $(ADDITIONAL_LIBS)
...
export PX_VAL = 0.0285
# mm/layer value - keep same to start 
export LAYER_VAL = 0.03
